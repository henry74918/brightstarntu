    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (location)
        {
            ...
            if (mLocation != null){
            	...
            	Toast.makeText(this, (String) this.getResources().getText(R.string.set_loc) + "\n" +
            			(String) this.getResources().getText(R.string.longigude)+ round(dLongitude) + "\n" +
            			(String) this.getResources().getText(R.string.latitude) + round(dLatitude),

	...
	public void initConstellations() {
		int RD[][][] = {
    			...
    			},
    			{
    			    ...
    			    {23,41,46,17,47,0, 1},//A2   Aquarius
    			...
    			},
    			{
    			    ...
    			    {13,51,50,32,59,41,1},//k    Centaurus
    			...
    			},
    			{
    			    ...
    			    {6, 28,50,7, 2, 4, 1},//£]   Monoceros
    			    {6, 23,46,4, 35,45,0},//£`   Monoceros
    			...
    			},
    			{
    			    ...
    			    {17,15,21,26,36,5, 1},//A    Ophiuchus
    			...
    			},
    			{
    			    ...
    			    {5, 40,46,1, 56,34,1},//£a   Orion
    			    {5, 47,45,9, 40,11,1},//£e   Orion
    			    {5, 14,32,8, 12,6, 1},//£]   Orion
    			    {5, 32,0, 0, 17,4, 1},//£_   Orion
    			    {5, 25,8, 6, 20,59,0},//£^   Orion
    			    {5, 35,8, 9, 56,6, 0},//£f   Orion
    			    {5, 55,10,7, 24,25,0},//£\   Orion
    			},
    			{
    			    {5, 40,46,1, 56,34,1},//£a   Orion
    			...
    			},
    			{
    			    ...
    			    {19,9, 46,21,1, 25,1},//£k   Sagittarius
    			...
    			},
    			{
    			    ...
    			    {16,11,59,19,26,59,1},//£h   Scorpius
    			},
    			{
    			    {15,58,51,26,6, 51,1},//£k   Scorpius
    			...
    			},
    			{
    			    ...
    			    {13,23,56,54,55,18,0},//£a   Ursa_Major
    			...
    			},
    			{
    			    ...
    			    {11,18,11,31,31,45,0},//£i   Ursa_Major
    			},
    			{
